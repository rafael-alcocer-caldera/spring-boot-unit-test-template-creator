...
public enum TestingFramework {
    ...
    private String importTestClass;

    private TestingFramework(String importTestClass) {
        this.importTestClass = importTestClass;
    }

    public String getImportTestClass() {
        return importTestClass;
    }
}
